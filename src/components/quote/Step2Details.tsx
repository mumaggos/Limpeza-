      ...
      <div className="space-y-8 mb-8">
        ...
        {hasLaundry && (
          <div className="bg-blue-50 border border-blue-200 p-6 rounded-2xl">
            <h3 className="font-semibold text-blue-900 mb-4">Serviço de Lavandaria</h3>
            <div>
              ...
              <input
                ...
                placeholder="Ex: 2 sacos grandes de 50L ou 40 peças"
        ...
        {hasSofas && (
          <div className="bg-emerald-50 border border-emerald-200 p-6 rounded-2xl">
            <h3 className="font-semibold text-emerald-900 mb-4">Limpeza de Sofás e Tapetes</h3>
            <div>
              <label className="block text-sm font-medium text-emerald-900 mb-2">O que pretende limpar?</label>
              <textarea
                value={data.itemType || ""}
                onChange={(e) => updateData({ itemType: e.target.value })}
                placeholder="Ex: 1 sofá de 3 lugares e 2 tapetes (2x2m)"
                rows={3}
